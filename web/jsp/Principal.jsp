<%-- 
    Document   : Principal
    Created on : 13/07/2015, 03:28:56 PM
    Author     : Wilson
--%>
                ...
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <p class="lead">
                                La siguiente aplicación se creo con el fin de facilitar, el prestamo de recursos de libros para la Universidad de Pamplona.
                                Se espera que la interacción con la aplicación sea de su total agrado sino vallase al carajo.
                            </p>
                            <center>
