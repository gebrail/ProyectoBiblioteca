<%-- 
    Document   : listarxusername
    Created on : 5/08/2015, 09:37:00 PM
    Author     : Wilson
--%>
...
<html>
    <head>
        ...
        <title>Ver Listado De Cuentas por username</title>
        <script src="../js/gest_cuentas.js"></script>
        <%@include file="../jsp/head.html"%>
    </head>

    <body onload="listadodecuentasxusername();">
                            ...
                            <div class="content-panel">
                                ...
                                <section id="unseen">
                                    <table class="table table-bordered table-striped table-condensed">
                                        ...
                                        <tbody id="listadodecuentasusername">
                                        </tbody>
                                    </table
